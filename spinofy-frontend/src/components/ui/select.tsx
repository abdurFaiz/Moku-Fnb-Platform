...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // 🔹 Modern input style
        "flex items-center justify-between w-full h-[60px] px-6 py-4 text-base rounded-2xl border border-gray-200 bg-white shadow-sm outline-none transition-all duration-200",
        // 🔹 Placeholder & disabled
        "placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50",
        // 🔹 Focus ring and active
