...
describe('PrivacyPolicy', () => {
    ...
    describe('Component Rendering', () => {
        ...
        it('should render main title', () => {
            renderComponent();
            const titles = screen.getAllByText(privacyPolicyData.title);
            expect(titles.length).toBeGreaterThan(0);
        });

        it('should render description', () => {
            renderComponent();
            expect(screen.getByText(privacyPolicyData.description)).toBeInTheDocument();
        });
    });
    ...
    describe('Sections Display', () => {
        ...
        it('should render correct number of sections', () => {
            ...
            expect(sections.length).toBe(privacyPolicyData.sections.length);
        });
    });
    ...
    describe('Icons Display', () => {
        ...
        it('should render Database icon for section 1', () => {
            const { container } = renderComponent();
    ...
    describe('Footer Section', () => {
        it('should render footer with commitment message', () => {
            renderComponent();
            expect(screen.getByText(/Kami berkomitmen untuk melindungi privasi Anda/)).toBeInTheDocument();
        });
    ...
    describe('Accessibility', () => {
        ...
        it('should use semantic heading for section titles', () => {
            ...
            expect(sectionHeadings.length).toBe(privacyPolicyData.sections.length);
        });
