...
export default function Welcome() {
    ...
    const handleGuestClick = () => {
        // Navigate to guest mode - update with actual route
        console.log("Continue as guest");
    };
    return (
        <div className="min-h-[844px] bg-white flex flex-col">
            {/* Main Content Container */}
            <div className="flex-1 flex flex-col max-w-[390px] mx-auto w-full">
                {/* Hero Image Section */}
                <div className="relative w-full ">
                    <img
                        src="./assets/images/static/welcome-image.png"
                ...
                {/* Content Section */}
                <div className="flex-1 flex flex-col justify-between px-4 md:px-8">
                    <div className="flex flex-col gap-6 max-w-md mx-auto w-full">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-base text-body-grey leading-normal">
                                Scan QR di mejamu, pilih menu, dan pesan
                                langsung dari HP kamu. Praktis!
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <button
                                ...
                                className="flex items-center cursor-pointer justify-center gap-3 w-full py-4 px-6 bg-light-green hover:bg-light-green/90 transition-colors rounded-[32px] text-white font-medium text-base"
                            >
                                <svg
                                    className="w-6 h-6"
                                    viewBox="0 0 25 24"
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs text-bg-body-grey">
                                    Atau
                                </span>
                                <div className="flex-1 h-px bg-body-grey"></div>
                            </div>
