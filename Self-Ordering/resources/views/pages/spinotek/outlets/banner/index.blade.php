        ...
        <div class="col">
            <div class="px-3 py-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="">
                        <h5 class="mb-0">List Banner {{ $outlet->name }} ({{ $banners->count() }})</h5>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".banner-modal"
                            data-url="{{ route('spinotek.outlets.banners.create', [$outlet->slug]) }}"
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdownmenu-primary">
                                                        ...
                                                        <a class="dropdown-item d-flex align-items-center"
                                                            ...
                                                            data-url="{{ route('spinotek.outlets.banners.edit', [$outlet->slug, $banner]) }}"
                                                            data-title="Ubah Banner">
                                                            <i class="bx bxs-edit-alt me-1"></i> Ubah
                                                        </a>
                                                        <a class="dropdown-item d-flex align-items-center action-delete"
                                                            href="#!"
                                                            data-url="{{ route('spinotek.outlets.banners.destroy', [$outlet->slug, $banner->id]) }}">
